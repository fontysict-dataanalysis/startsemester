...
## <span> <img class="inline-h1-icon" src="./assets/svg/info.svg" /> Over deze site
...
## <span> <img class="inline-h1-icon" src="./assets/svg/route.svg" /> Bepaal je persoonlijke programma
...
## <span> <img class="inline-h1-icon" src="./assets/svg/question.svg" /> How-to's
...
## <span> <img class="inline-h1-icon" src="./assets/svg/book.svg" /> Online cursussen
...
## <span> <img class="inline-h1-icon" src="./assets/svg/search.svg" /> Cheat sheets & andere bronnen
...
## <span> <img class="inline-h1-icon" src="./assets/svg/comment.svg" /> Bijdragen of opmerkingen?
